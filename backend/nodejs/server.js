...
// Quick action endpoint for specific transformations
    ...
    try {
        ...
        switch (action) {
            case 'shorten':
                ...
                break;
            case 'expand':
                userPrompt = `Expand this text with more detail: "${text}"`;
                break;
            case 'formal':
                userPrompt = `Make this text more formal and professional: "${text}"`;
                break;
            case 'casual':
                userPrompt = `Make this text more casual and friendly: "${text}"`;
                break;
            case 'emojify':
                userPrompt = `Add relevant emojis to this text: "${text}"`;
                break;
            case 'fix_grammar':
                userPrompt = `Fix any grammar and spelling errors in this text: "${text}"`;
                break;
            case 'translate':
                userPrompt = `Translate this text to English: "${text}"`;
                break;
            default:
